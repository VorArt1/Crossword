# Crossword
Этот учебный проект представляет собой консольное приложение на C#, которое позволяет разгадывать кроссворды. Приложение реализует основные механики работы с сеткой кроссворда, проверкой слов и ведением счёта.
# Установка
